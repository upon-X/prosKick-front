...
// YA NO USA PERSISTENCIA - las cookies del navegador manejan la sesión
export const useAuthStore = create<AuthState>()((set) => ({
  ...
  login_with_google: async () => {
    ...
    throw new Error("login_with_google debe ser implementado en el contexto");
  },
  ...
  refresh_user_data: async () => {
    // Esta función se implementará en el contexto
    throw new Error("refresh_user_data debe ser implementado en el contexto");
  },
